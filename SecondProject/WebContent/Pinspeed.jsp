...
.searchbg {
	...
	height: 100%;
	padding-top: 280px;
	background-image: url('img/main_bg06.png');
...
<body>
	...
	<div class="scene searchbg">
		...
		<div style="margin-top: 60px; text-align: center;">
			<form action="PinServlet" method="post">
				<input type="hidden" name="command" value="searchpin"> <input
					type="hidden" name="page" value="1"> <input type="text"
					name="stext"
					style="width: 550px; height: 40px; opacity: 0.8; border-top-left-radius: 7px; border-bottom-left-radius: 7px; border: 1px solid #aaa;">
	...
	<div class="container">
		...
		<hr
			style="width: 1037px; border-top: 2px solid #eee; margin-top: 20px;">
		<div
			style="width: 100%; text-align: center; padding: 0 0 10px 0; display: table;">
			...
			<div class="diary fadeInUp animate">
				<a
					...
					<div class="Dimage" style="">
						<img style="width: 100%; height: 100%;"
							src="https://maps.googleapis.com/maps/api/staticmap?center=<%=dao.getPin(pinlist.get(i)[0]).getLat()%>,<%=dao.getPin(pinlist.get(i)[0]).getLng()%>&zoom=13&size=600x300&maptype=roadmap
				...
				<div class="diary-textbox"
					style="line-height: 30px; margin-bottom: 5px; display: table; width: 100%;">
					<div class="starRev">
						<%
							for (int j = 1; j <= 10; j++) {
									if (j % 2 == 1) {
	...
	<script>
		$(window).scroll(function() {
			...
			if ($(this).scrollTop() >= 100)
				$el.addClass('fadeInUp').addClass('animate');
			else
